...
$(document).ready(async () => {
    ...
    $('#username')[0].innerHTML = `${system.account.displayName}<img src="./src/images/fortnite/Shell-Top-Crown.png" style="position: relative;left: 1vh;top: 5px;">`;
    ...
    $('#InformationButton').children().click(async () => {
        ...
        $(document).unbind('click');
        menu[0].innerHTML = `<div class="cosmetic">Information<br><div id="FriendsButton" class="clickHereButton" style="padding: 3px;font-size: 20px;margin: 10px;background-color: black;"><img width="50" height="50" src="./src/images/fortnite/T-Icon-Friends-XXL.png"></div><div id="ColorSchemeButton" class="clickHereButton textBackground gradient" style="padding: 3px;font-size: 20px;margin: 10px;">Color Scheme</div></div>`;
        menu.fadeIn(250);
        menu.draggable({
            "containment": "window"
        });
